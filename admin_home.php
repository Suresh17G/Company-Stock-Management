...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            $alert_dept = ($row>0)? "<div class=''><h3 CLASS='alert alert-success text-center'> Total Shareholders - ".$row['dept_available']."</h3></div>":"<div class=''><h3 CLASS='alert alert-danger'> NO DEPARTMENTS AVAILABLE </h3></div>";
            echo $alert_dept;
            ?>
        </div>
        <div class="col-md-4">
            ...
            $alert_supplier = ($row>0)? "<div class=''><h3 class='alert alert-success text-center'> Available Companies - ".$row['supplier_available']."</h3></div>":"<div class=''><h3 CLASS='alert alert-danger text-center'> NO SUPPLIER AVAILABLE </h3></div>";
            echo $alert_supplier;
            ?>
        </div>
        <div class="col-md-4">
