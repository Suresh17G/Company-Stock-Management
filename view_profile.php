...
<div class="panel-footer">
    ...
    <div class="well well-lg text-center text-capitalize">
        <div class="well well-sm">
            <b>USER ID :</b><em><?php echo $row['dept_id'] ;?></em>&nbsp;&nbsp;&nbsp;<a href='#' class='btn btn-success btn-sm'><span class='glyphicon glyphicon-edit'></span></a>
        </div>
        <div class="well well-sm">
        <b>USER NAME :</b><em><?php echo $row['dept_name'] ;?></em>&nbsp;&nbsp;&nbsp;<a href='#' class='btn btn-success btn-sm'><span class='glyphicon glyphicon-edit'></span></a>
    </div>    
    <div class="well well-sm">
