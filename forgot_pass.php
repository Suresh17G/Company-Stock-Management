...
<div class="row">
    <div class="col-md-6 col-sm-12 mx-auto col-md-offset-3">
        <div class=" jumbotron card card-body bg-light mt-5">
            <h2 clas="text-center">Reset Password For Shareholders</h2>
            <p></p>
            <form action="<?php echo URLROOT; ?>/actions/__forgot_pass.php" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="email" class="form-control form-control-lg" placeholder="Enter Shareholder Email" required>
                </div>
                 <div class="form-group">
                    <div class="">
                        <label for="dept_id">Shareholder id: <sup>*</sup></label>
                        <!--begin option-->
                        <?php
